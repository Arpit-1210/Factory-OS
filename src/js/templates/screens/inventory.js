...
export default `      <div class="screen" id="sc-inventory">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:10px">
          ...
          <div style="display:flex;gap:8px"><button class="btn btn-sm" data-click="printPage">🖨️ Print</button><button class="btn btn-amber btn-sm" data-click="renderInventory">↻ Refresh</button></div>
        </div>
        <div style="margin-bottom:16px">
          <input type="text" id="inv-search" placeholder="🔍 Search any product or material..." data-input="renderInventory"
