...
export default `      <div class="screen" id="sc-sheets">
        ...
        <div class="card" style="max-width:640px;margin-bottom:16px">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px">
            <button class="btn btn-jade" data-click="backupNow">💾 Backup Now</button>
            <button class="btn btn-blue" data-click="restoreFromBackup">📂 Restore from Backup</button>
            <button class="btn" data-click="forceSync">↑ Force Sync</button>
            <button class="btn btn-amber" data-click="emergencyPush">🚨 Push Local Data to Firebase</button>
          </div>
          ...
          <div style="display:flex;flex-direction:column;gap:16px">
            <div style="display:flex;gap:12px;align-items:flex-start">
              ...
              <div style="flex:1"><div style="font-weight:600;margin-bottom:4px">Paste Apps Script</div>
                ...
                <textarea id="apps-script-code" readonly data-click="selectAllIn" style="width:100%;height:160px;background:var(--surface2);border:1px solid var(--border);border-radius:var(--r);padding:10px;font-family:var(--mono);font-size:10px;color:var(--text3);resize:vertical;outline:none"></textarea>
                <button class="btn btn-sm btn-blue" style="margin-top:6px" data-click="copyScript">Copy Script</button>
            ...
            <div style="display:flex;gap:12px;align-items:flex-start">
              ...
              <div style="flex:1">
                ...
                <div class="fld"><label>Web App URL</label><input id="sheets-url" placeholder="https://script.google.com/macros/s/..." data-input="saveUrl"></div>
                <button class="btn btn-sm btn-blue" style="margin-top:8px" data-click="testConnection">🔗 Test Connection</button>
