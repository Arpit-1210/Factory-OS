...
export default `      <div class="screen" id="sc-raw">
        ...
        <div class="card">
          ...
          <div class="fg fg4">
            ...
            <div class="fld"><label>Material</label><select id="raw-mat" data-change="rawFill"><option value="">— select —</option></select></div>
            <div class="fld"><label>Quantity</label><input type="number" id="raw-qty" placeholder="0" data-input="rawFill"></div>
            <div class="fld"><label>Total Cost ₹ (auto)</label><input type="number" id="raw-cost" placeholder="0"><div class="hint" id="raw-hint"></div></div>
          </div>
          <button class="btn btn-amber btn-sm" data-click="issueRaw">+ Issue</button>
        </div>
        ...
        <button class="btn btn-amber" data-click="go" data-args="[&quot;day&quot;]">→ Day Sheet</button>
      </div>`;
